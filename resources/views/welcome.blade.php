...
<head>
    ...
    <title>Becho - B2B Garments Trading Platform</title>
...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="lead text-white-50 mb-5 fs-4">
                        Connect with verified manufacturers, wholesalers, and retailers. Trade garments in bulk with competitive pricing and secure transactions.
                    </p>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-lg-8 mx-auto text-center">
                    <h2 class="display-4 fw-bold mb-4">Why Choose Becho?</h2>
                    <p class="lead text-muted">Revolutionizing B2B garments trading with modern technology and trusted partnerships</p>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="text-muted">Trade with confidence knowing all our suppliers are verified and vetted for quality and reliability.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="text-muted">Get better prices with our tiered bulk pricing system designed for wholesale transactions.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="text-muted">Request and negotiate prices directly with suppliers through our integrated quotation system.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="text-muted">Find amazing deals on surplus inventory and stocklot items at discounted prices.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="text-muted">Track your orders from confirmation to delivery with real-time updates and notifications.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="text-muted">Access the platform anywhere, anytime with our responsive design and mobile optimization.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="about" class="py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h2 class="display-4 fw-bold mb-4">About Becho</h2>
                    <p class="lead mb-4">
                        Becho is Bangladesh's premier B2B e-commerce platform specifically designed for the garments industry. 
                        We connect manufacturers, wholesalers, and retailers in a seamless digital marketplace.
                    </p>
                    <ul class="list-unstyled">
                        <li class="mb-3"><i class="fas fa-check-circle text-success me-3"></i>Trusted by 500+ verified suppliers</li>
                        <li class="mb-3"><i class="fas fa-check-circle text-success me-3"></i>Secure payment processing</li>
                        <li class="mb-3"><i class="fas fa-check-circle text-success me-3"></i>24/7 customer support</li>
                        <li class="mb-3"><i class="fas fa-check-circle text-success me-3"></i>Quality assurance guarantee</li>
                    </ul>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <h5 class="fw-bold mb-3">Becho</h5>
                    <p class="text-muted">Bangladesh's leading B2B garments trading platform connecting manufacturers, wholesalers, and retailers.</p>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="text-muted mb-0">&copy; 2024 Becho. All rights reserved.</p>
                </div>
